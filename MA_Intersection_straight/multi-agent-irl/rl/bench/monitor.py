...
class Monitor(Wrapper):
    ...
    def step(self, action):
        ...
        # obs_lstm, ob, reward, done, info, ini_step, ini_ob, actions_new_n, rew_n_social_generate, collide_situation
        obs_lstm, ob, rew, done, info, ini_step_n, ini_ob, actions_new_n, rew_n_social_generate, collide_situation = self.env.step(action)
        ...
        # obs_lstm, ob, reward, done, info, ini_step, ini_ob, actions_new_n
        return (obs_lstm, ob, rew, done, info, ini_step_n, ini_ob, actions_new_n, rew_n_social_generate, collide_situation)
