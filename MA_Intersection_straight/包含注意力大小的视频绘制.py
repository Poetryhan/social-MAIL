...
# root1 = r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs\MA_Intersection_straight' \
#         r'\results_evaluate\v31\视频\7\figure_save'
# root2 = r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs\MA_Intersection_straight' \
#         r'\results_evaluate\v31\视频\7\figure_save\temp_top_view_figure'
# root3 = r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs\MA_Intersection_straight' \
#         r'\results_evaluate\v31\视频\7\figure_save\top_view_video'
...
def plot_top_view_ani_with_lidar_label(trj_in, scenario_landmark_trj, scenario_label_in, time_id_in, frame_id_in):
                ...
                if coords_jiaohu_same_agent[0] != -4:
                    ...
                    if len(same_agent_trj_potential) != 0:
                        ...
                        temp_text = plt.text(same_agent_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(same_agent_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_sameagent),
                                             style='italic',
                ...
                if coords_jiaohu_left_agent1[0] != -4:
                    ...
                    if len(left_agent1_trj_potential) != 0:
                        ...
                        temp_text = plt.text(left_agent1_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(left_agent1_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_leftagent1),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white', rotation=0,
                                             size=5, zorder=1000)
                        temp_text.set_path_effects(
                ...
                if coords_jiaohu_left_agent2[0] != -4:
                    ...
                    if len(left_agent2_trj_potential) != 0:
                        ...
                        temp_text = plt.text(left_agent2_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(left_agent2_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_leftagent2),
                                             style='italic',
                ...
                if coords_jiaohu_left_agent3[0] != -4:
                    ...
                    if len(left_agent3_trj_potential) != 0:
                        ...
                        temp_text = plt.text(left_agent3_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(left_agent3_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_leftagent3),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white',
                                             rotation=0,
                                             size=5, zorder=1000)
                ...
                if coords_jiaohu_right_agent1[0] != -4:
                    ...
                    if len(right_agent1_trj_potential) != 0:
                        ...
                        temp_text = plt.text(right_agent1_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(right_agent1_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_rightagent1),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white',
                                             rotation=0,
                                             size=5, zorder=1000)
                ...
                if coords_jiaohu_right_agent2[0] != -4:
                    ...
                    if len(right_agent2_trj_potential) != 0:
                        ...
                        temp_text = plt.text(right_agent2_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(right_agent2_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_rightagent2),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white',
                                             rotation=0,
                                             size=5, zorder=1000)
                ...
                if coords_jiaohu_right_agent3[0] != -4:
                    ...
                    if len(right_agent3_trj_potential) != 0:
                        ...
                        temp_text = plt.text(right_agent3_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str(right_agent3_jiaohu['id'].iloc[0]) + '_' + str(temp_alpha_rightagent3),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white',
                                             rotation=0,
                                             size=5, zorder=1000)
                ...
                if coords_jiaohu_left_landmark1[0] != -5:
                    ...
                    if len(left_landmark1_trj_potential) != 0:
                        ...
                        temp_text = plt.text(left_landmark1_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str('ld') + str(int(left_landmark1_jiaohu['id'].iloc[0])) + '_' + str(
                                                 temp_alpha_leftlandmark1),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white',
                                             rotation=0,
                                             size=5, zorder=1000)
                ...
                if coords_jiaohu_right_landmark1[0] != -5:
                    ...
                    if len(right_landmark1_trj_potential) != 0:
                        ...
                        temp_text = plt.text(right_landmark1_jiaohu['x_real'].iloc[0] + 2,
                                             ...
                                             str('ld') + str(int(right_landmark1_jiaohu['id'].iloc[0])) + '_' + str(
                                                 temp_alpha_rightlandmark1),
                                             style='italic',
                                             weight='heavy', ha='center', va='center', color='white',
                                             rotation=0,
                                             size=5, zorder=1000)
    ...
    trj_save_name = r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs' \
                    r'\MA_Intersection_straight\results_evaluate\v31\有注意力的视频\figure_save' \
...
def top_view_video_generation(start_frame_num, start_time, scenario_label):
    ...
    for num in range(start_frame_num,
        ...
        image_filename = r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs' \
                         r'\MA_Intersection_straight\results_evaluate\v31\有注意力的视频' \
                         r'\figure_save/temp_top_view_figure/' \
                         + 'top_scenario_label_' + str(single_model_label) + \
    ...
    video_save_name_0 = fr'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs' \
                      fr'\MA_Intersection_straight\results_evaluate\v31\有注意力的视频' \
                      fr'\figure_save\top_view_video\{scenario_name}'
    ...
    video_save_name = fr'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs' \
                      fr'\MA_Intersection_straight\results_evaluate\v31\有注意力的视频' \
                      fr'\figure_save\top_view_video\{scenario_name}\'_scenario_label_{single_model_label}.avi'
...
if __name__ == '__main__':
    ...
    if top_view_video_generation_label:
        ...
        if version_1_2_label:  # 如果变量version_1_2_label存在
            ...
            '''
        scenario_label = 9
        scenario_name = str(scenario_label) + 'west_left'
        filedir = fr'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs\MA_Intersection_straight' \
                  fr'\results_evaluate\v31\有注意力的视频\专门生成生成轨迹的数据\{scenario_name}\\'
        ...
        for filename in file_namelist:
            trj_read_name = filedir + filename
            f_generate = open(trj_read_name, 'rb')
            all_generate_trj = pickle.load(f_generate)
            # all_generate_trj包含每一个model下一个场景的各类参数，第一层是model_id，第二层只有一个（就是夹层），
            # 第三层是各类信息（包括ob attention_weight 等等），第四层是各类信息的具体值

            all_model_label = list(range(0, 21))  # pd.unique(temp_trj['model_id']).tolist()
            # all_model_label = [15]  # pd.unique(temp_trj['model_id']).tolist()
            # delete previous frame jpgs (might or might not exist)
            filelist = glob.glob(os.path.join(
                r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs\MA_Intersection_straight' \
                  r'\results_evaluate\v31\有注意力的视频\figure_save\temp_top_view_figure',
                "*.jpg"))  # 存放中间步骤的图的路径
            # for f in filelist:
            #     os.remove(f)

            for single_model_label in all_model_label:  # 遍历一个文件中的每一个场景

                filelist = glob.glob(os.path.join(
                    r'D:\Study\同济大学\博三\面向自动驾驶测试的仿真\sinD_nvn_xuguan\ATT-social-iniobs'
                    r'\MA_Intersection_straight\results_evaluate\v31\有注意力的视频\figure_save\temp_top_view_figure\\',
                    "*.jpg"))  # 存放中间步骤的图的路径
                for f in filelist:
                    os.remove(f)
                    print('删除了文件')
                ...
                # 挑选几个rmse比较小的model_id
                if single_model_label-0 >= 0:
                    ...
                    scenario_print = 'Top view video now in phase: ' + str(single_model_label)
                    print(scenario_print)


                    scenario_trj_ob = all_generate_trj[single_model_label][0]['ob']
                    scenario_trj_att_weight = all_generate_trj[single_model_label][0]['all_attention_weight_spatial']  # shape为（230，21,10,10）
                    scenario_trj_ac = all_generate_trj[single_model_label][0]['ac']
                    print('scenario_trj_ob:',type(scenario_trj_ob),len(scenario_trj_ob))
                    print('scenario_trj_att_weight:', type(scenario_trj_att_weight), len(scenario_trj_att_weight))  # <class 'list'> 8
                    ...
                    for left_i in range(3):
                        ...
                        print('left_weight_i_array:', type(left_weight_i_array), len(left_weight_i_array))  # <class 'numpy.ndarray'> 230
                        ...
                        left_i_use = pd.concat([left_trj_i_use, left_weight_i_use], axis=1)  # 横向拼接
                    ...
                    left_scenario_use['model_id'] = single_model_label
                    ...
                    left_scenario_use.columns = ['time','x','y','vx','vy','dx','dy','heading_angle_last1','des','vx_last1','vy_last1',
                                        ...
                                        'weight_0','weight_same1','weight_left1','weight_left2','weight_left3','weight_right1','weight_right2','weight_right3','weight_left_landmark1','weight_right_landmark1',
                    ...
                    for straight_i in range(3,8):
                        ...
                        straight_i_use = pd.concat([straight_trj_i_use, straight_weight_i_use], axis=1)  # 横向拼接
                    ...
                    straight_scenario_use['model_id'] = single_model_label
                    ...
                    file_path = f'D:/Study/同济大学/博三/面向自动驾驶测试的仿真/sinD_nvn_xuguan/ATT-social-iniobs' \
                                f'/MA_Intersection_straight/results_evaluate/v31/有注意力的视频/社会倾向' \
                                f'/专门生成生成轨迹的数据/{scenario_name}'
                    scenario_data_file_path = f'{file_path}/scenario{scenario_name}_data.csv'
                    # 创建文件夹（如果不存在）
                    ...
                    for frame_id in range(start_frame_num, int(end_frame_num) + 1):  # 遍历一个场景内每一帧
                        ...
                        plot_top_view_ani_with_lidar_label(scenario_data, scenario_landmark_trj, single_model_label, frame_time, frame_id)
                    # ---------- video generation ----------
