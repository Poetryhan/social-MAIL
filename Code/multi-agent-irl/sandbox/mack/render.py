...
@click.option('--path', type=click.STRING,
              default='C:\\Users\\uqjsun9\\Dropbox\\Python\\MA-AIRL-master\\multi-agent-irl\\sandbox\\mack\\tmp'
              )
...
def render(path):
    ...
    make_model = lambda: Model(
        CategoricalPolicy, ob_space, ac_space, 1, total_timesteps=1e6, nprocs=2, nsteps=500,
    ...
    pkl.dump(sample_trajs, open('multi-agent-trj/expert_trjs/simple30.pkl', 'wb'))
